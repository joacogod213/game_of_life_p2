...
{
    // la única razón de cambio de esta clase es "cómo se lee el tablero
    ...
    // responsabilidades.
    // es la clase que tiene toda la información necesaria para leer
    ...
    {
        /// <summary>
        /// Lee el archivo y arma la matriz
